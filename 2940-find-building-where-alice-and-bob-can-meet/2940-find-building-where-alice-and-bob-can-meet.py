...
class Solution:
    def leftmostBuildingQueries(self, heights: List[int], queries: List[List[int]]) -> List[int]:
        ...
        for queryIndex, a, b in sorted([IndexedQuery(i, min(a, b), max(a, b)) for i, (a, b) in enumerate(queries)],
            key=lambda x: -x.b
        ):
    ...
    def _lastGreater(self, A: List[int], target: int, heights: List[int]) -> int:
        """
